...
path_yaml = rospy.get_param('~yaml/path', '/home/turtlebot2/catkin_ws/src/uvone_robot/uvone_robot_navigation/maps/')
file_yaml = rospy.get_param('~yaml/filename', 'octomap_grid.yaml')
route_path = rospy.get_param('~route/path', '/home/turtlebot2/catkin_ws/src/uvone_robot/uvone_robot_navigation/path/')
